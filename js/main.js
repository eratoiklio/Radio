...
// var stationsName;
    ...
    stations.each(function(index, element) {
        ...
        $(element).on('click', function() {
            ...
            if(currentStation != undefined && this.on)
            {
                currentStation.addClass("hidden");
                $(".currentStationName").text("");
                audio.src = parent.data("");
                console.log("powininienem wejść");
                this.on=false;
            }
            else {
                ...
                console.log(" nie powininienem wejść");
